                    ...
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-bot15 city choose" name="city" id="city">
                                            ...
                                            @foreach($city as $key => $cit)
                                                <option value="{{$cit->matp}}">{{$cit->matp}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Ghi chú</label>
                                    <textarea style="resize: vertical" value="{{old('shipping_note')}}" class="form-control shipping_note" name="shipping_note" id="" cols="10" rows="5"></textarea>
                                    <div id="emailHelp" class="form-text"></div>
                                </div>
                                <div class="mb-3">
                                    <input type="button" value="Xác nhận đơn hàng" name="send_order" class="checkout-button button alt wc-forward send_order form-control">
                            ...
                            <div id="payment">
                                ...
                                <ul class="payment_methods methods">
                                    ...
                                    <li class="payment_method_cheque">
                                        <input checked type="radio" data-order_button_text="" value="0" name="payment_method" class="input-radio payment_method" id="payment_method_cheque">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="col-md-12" style="margin-top: 30px">
                                    @php
                                        $quantity = 0;
                                    @endphp
                                    <div class="product-content-right mt-4">
