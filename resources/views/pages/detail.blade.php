            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    ...
                    <div class="alert">
                        ...
                        <strong>{{session('message')}} <a href="{{route('contact')}}" style="text-decoration: underline;">Đi đến trang liên hệ</a></strong>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button onclick="{{route('contact')}}" type="button" class="btn btn-primary">Đi đến trang liên hệ</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="rating-chooser">
                                            ...
                                            <div class="rating-wrap-post">
                                                <ul class="list-inline rating" title="Đánh giá sau">
                                                    @for($count=1;$count<=5;$count++) @php if ($count<=$rating){ $color='color:#ffcc00;' ; }else { $color='color:#ccc' ; } @endphp <li title="Đánh giá sao" class="rating" style="font-size: 30px; cursor: pointer; {{$color}}  " id="{{$detail->id}}-{{$count}}" data-index="{{$count}}" data-product_id="{{$detail->id}}" data-rating="{{$rating}}">&#9733</li>
                                                        @endfor
                                                </ul>
                                            </div>
                                        </div>
